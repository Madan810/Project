...
renderBitmapString(move_x,0+3.8,move_z-4,GLUT_BITMAP_HELVETICA_18,"  LEVEL : ");
  ...
  renderBitmapString(move_x,2,move_z,GLUT_BITMAP_HELVETICA_18,"SARIM AHMAD(1DT14CS087)");
  renderBitmapString(move_x,1,move_z,GLUT_BITMAP_HELVETICA_18,"VISHWAS GEORGE(1DT14CS114)");

renderBitmapString(move_x,-1,move_z+3,GLUT_BITMAP_HELVETICA_18,"SPACE TO CONTINUE");
renderBitmapString(move_x,-2,move_z+3,GLUT_BITMAP_HELVETICA_18,"PRESS 8 FOR UP");
renderBitmapString(move_x,-3,move_z+3,GLUT_BITMAP_HELVETICA_18,"PRESS 2 FOR DOWN");
renderBitmapString(move_x,-4,move_z+3,GLUT_BITMAP_HELVETICA_18,"PRESS 4 FOR LEFT");
renderBitmapString(move_x,-5,move_z+3,GLUT_BITMAP_HELVETICA_18,"PRESS 6 FOR RIGHT");
